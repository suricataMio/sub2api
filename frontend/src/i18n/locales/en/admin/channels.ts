export default {
    ...
    subscriptions: {
      ...
      resetAll: 'Reset All',
      resetAllWindows: 'daily, weekly, and monthly',
      resetQuotaConfirmSelected: "Reset the {window} usage quota for '{user}'? The selected usage window will be zeroed and restarted.",
