...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	telegramService := service.ProvideTelegramService()
	opsAlertEvaluatorService := service.ProvideOpsAlertEvaluatorService(opsService, opsRepository, emailService, telegramService, redisClient, configConfig)
